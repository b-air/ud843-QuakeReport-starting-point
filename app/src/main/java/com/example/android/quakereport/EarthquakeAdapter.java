...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        String originalLocation = currentPlace.getPlace();
        ...
        Date dateObject = new Date(currentPlace.getTimeInMilli());
        ...
        //Find the TextView in the earthquake layout with ID
        TextView magnitude = (TextView) listItemView.findViewById(R.id.magnitude);
        // Format the magnitude to show 1 decimal place
        String formattedMagnitude = formatMagnitude(currentPlace.getMagnitude());
