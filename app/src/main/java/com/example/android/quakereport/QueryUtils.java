...
public final class QueryUtils {
    ...
    private static String SAMPLE_JSON_RESPONSE = testJson;
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject collection = new JSONObject(SAMPLE_JSON_RESPONSE);
            // Extract “features” JSONArray
            JSONArray feature = collection.getJSONArray("features");

            // Loop through each feature in the array
            for (int i = 0; i < feature.length(); i++) {
                // Get earthquake JSONObject at position i
                JSONObject object = feature.getJSONObject(i);
                ...
                String url = objectProperties.getString("url");
